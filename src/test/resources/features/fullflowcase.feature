Feature: Page create information of cases
  ...
  Scenario Outline: Successful create flow complete cars
    ...
    Examples:
      ...
      | Sergio.Anaya | Colombia_2026* | B202201064435401 | solicitante autos | 3122554788 | SBV95F       | Calle 34e #43-54 | Avenida colombia prueba autos | Cordoba    | Monteria     | No        | Autos | Abogado En Sitio Arl | Cerca a supermercado pruebas | Programado  | PROVEEDOR PRUEBA | Toma servicio    | 200                | 500                       | 3122554385         | 3221454746    | 3214576585    | pruebas proveedor automaticas | Aceptado y en desplazamiento | Prueba | Monitoreo finalizacion del servicio | 2021-05-31 | 09:19am     | Yaira Manuela  | Asegurado      | Monitoreo preventivo | Acepte               | No                 | pruebas automaticas autos | pruebas automaticas monitoreo flujo completo | En sitio    | Guardianes de la vida | Sebastian Ossa Taborda | Adulto mayor | No                 | pruebas automaticas escalamiento sura | Abogado virtual           | Cambio abogado virtual a sitio | No                      | observacion flujo completo novedades | Administrativo Aya            | No                              | pruebas automaticas creacion documentacion CNM | Proveedor  | SMS          | prueba finalizacion autos completa | Concluido   |
