Feature: Parametrizacion Tableros de Control UCK
  ...
  Scenario Outline: Edicion Exitosa UCK
    ...
    Examples:
      ...
      | Sergio.anaya | Colombia_2027* | 1 February 2022 | Solicitud por Avería Pesado | Grua Pesados(¿Póliza de manejo especial?) | No        | Prueba      | Registro guardado correctamente |