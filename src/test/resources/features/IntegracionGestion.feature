Feature: Integracion Gestion de Expedientes
  ...
  Scenario Template:Gestion de Servicios Duplicados
    ...
    Examples:
      ...
      | Sergio.anaya | Colombia_2021 | 7 de marzo de 2022 | 06   | Prueba | 3103904286 | Bogota D.C. | Bogota D.C. | SVF98S | Clle 20 | QA     | QA        | No      | No    | Autos | Abogado En Sitio | Registro guardado correctamente |