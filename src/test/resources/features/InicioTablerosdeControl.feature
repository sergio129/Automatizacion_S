Feature: Control boards parameterization
  ...
  Scenario Outline: Creacion Exitosa de Tablero de control de Casos
    ...
    Examples:
      | boardname                     | fieldsshow1 | fieldsshow2       | fieldsshow3 | fieldsshow4  | fieldsshow5 | misexpedientes | casestatus | statusservice | departmentrequest | service          | specialservice | assigneduser        | modalmessage                    |
      | Tablero Casos Automatizacion3 | Expediente  | Estado expediente | Asignado a  | Departamento | Proveedor   | no             | Pendiente  | Programado    | Antioquia         | Abogado En Sitio | Noo            | Yaira Manuela Admin | Registro guardado correctamente |
  ...
  Scenario Outline: Creacion de Tablero de control de Tareas de monitoreo
    ...
    Then Se visualiza mensaje de la modal<modalmessage>
    Examples:
      | boardname              | fieldsshow1 | fieldsshow2 | fieldsshow3 | fieldsshow4        | fieldsshow5    | misexpedientes | supplier                      | monitoringtype     | assigneduser        | modalmessage                    |
      | Tablero pruebas tareas | Servicio    | Línea       | Expediente  | Nombre de la tarea | Tipo monitoreo | Si             | 24 H CAR SERVICE SAS MEDELLIN | Monitoreo en Sitio | Yaira Manuela Admin | Registro guardado correctamente |
  ...
  Scenario Outline: Successful control boards closure case
    ...
    Examples:
      | boardname                            | fieldsshow1 | fieldsshow2              | fieldsshow3 | fieldsshow4 | fieldsshow5 | misexpedientes | service              | supplier                          | specialservice | assigneduser        | modalmessage                    |
      | Tablero pruebas cierre de expediente | Expediente  | Estado cierre expediente | Asignado a  | Servicio    | Proveedor   | Tal vez        | Abogado En Sitio Arl | 1A ELEGIDOS Y SOLUCIONES SAS CALI | Noo            | Yaira Manuela Admin | Registro guardado correctamente |
  ...
  Scenario Outline: Control boards cases successful edition
    ...
    Examples:
      | boardname             | fieldsshow1 | fieldsshow2 | fieldsshow3 | fieldsshow4       | fieldsshow5      | misexpedientes | casestatus | statusservice | departmentrequest | service          | specialservice | assigneduser | modalmessage                    |
      | Tablero pruebas casos | Línea       | Servicio    | Placa       | Documentación CNM | Expediente click | Tal vez        | Pendiente  | Programado    | Antioquia         | Abogado En Sitio | Noo            | Andres       | Registro guardado correctamente |
  ...
  Scenario Outline: Control boards task monitoring successful edition
    ...
    Examples:
      | boardname              | fieldsshow1  | fieldsshow2 | fieldsshow3        | fieldsshow4 | fieldsshow5 | misexpedientes | supplier                      | monitoringtype     | assigneduser        | modalmessage                    |
      | Tablero pruebas tareas | Departamento | Servicio    | Estado de la tarea | Asignado a  | Proveedor   | prueba         | 24 H CAR SERVICE SAS MEDELLIN | Monitoreo en Sitio | Yaira Manuela Admin | Registro guardado correctamente |
  ...
  Scenario Outline: Control boards closure case successful edition
    ...
    Examples:
      | boardname                            | fieldsshow1 | fieldsshow2          | fieldsshow3 | fieldsshow4    | fieldsshow5         | service              | supplier                          | specialservice | assigneduser | modalmessage                    |
      | Tablero pruebas cierre de expediente | Creado por  | ¿Concluido servicio? | Línea       | Fecha creación | Ultima modificación | Abogado En Sitio Arl | 1A ELEGIDOS Y SOLUCIONES SAS CALI | Noo            | Kevin        | Registro guardado correctamente |
