Feature: Page submodule state management
  ...
  Scenario Outline: Successful state management
    ...
    Examples:
      ...
      | yoarlys.carillo | Colombia2020* | 222222222222222 | Programado                   | Detalle expediente |
      | yoarlys.carillo | Colombia2020* | 222222222222222 | Aceptado y en desplazamiento | Detalle expediente |
