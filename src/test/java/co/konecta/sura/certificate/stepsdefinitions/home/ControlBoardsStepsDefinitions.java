package co.konecta.sura.certificate.stepsdefinitions.home;

import co.konecta.sura.certificate.task.home.ControlBoardsTask;
...
public class ControlBoardsStepsDefinitions {
    ...
    public void iTypeInformationInTheFieldsBoardNameAndFieldsShowAndOnlyMyCases(String boardName, String fieldsShow1, String fieldsShow2, String fieldsShow3, String fieldsShow4, String fieldsShow5) throws InterruptedException {
        ...
        Thread.sleep(2000);
        actor.attemptsTo(ControlBoardsTask.withInformationControlBoards(boardName, fieldsShow1, fieldsShow2, fieldsShow3, fieldsShow4, fieldsShow5));
    }
