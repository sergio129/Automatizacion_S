...
import co.konecta.sura.certificate.task.Parametrizacion.ControlBoardsParameterizationTask;
...
import static co.konecta.sura.certificate.userinterface.Parametrizacion.ControlBoardsParameterizationPage.*;
...
public class ControlBoardsParameterizationStepsDefinitions {
    ...
    public void iTypeInformationInTheCaseBoardParameterizationNameAndFieldsShowAndOnlyMyCases(String boardName, String fieldsShow) throws InterruptedException {
        actor.attemptsTo(Click.on(INPUT_BOARD_TYPE_PARAMETERIZATION),
                ...
                Thread.sleep(2000);
        actor.attemptsTo(ControlBoardsParameterizationTask.withInformationControlBoardsParameterization( boardName, fieldsShow));
    }
    ...
    @Then("^I view the modal save control boards parameterization with (.*)$")
