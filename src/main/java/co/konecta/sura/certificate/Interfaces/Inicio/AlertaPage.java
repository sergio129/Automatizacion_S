...
public class AlertaPage {
    ...
    public static final Target CAMPO_SERVICIO = Target.the("seleccionar el campo servicio UCK").located(By.cssSelector("[placeholder='Seleccionar Servicio']"));
    ...
    public static final Target CAMPO_OBSERVACION = Target.the("seleccionar el campo observacion").located(By.cssSelector("[placeholder='Observación']"));
    ...
    public static final Target BOTON_GUARDAR_EDICION=Target.the("clic boton guardar ").locatedBy("/html/body/div[3]/div[2]/div/mat-dialog-container/app-create-edit-alert-uck/form/div[2]/button[1]");

    public static final Target BUSCAR_DATO= Target.the("buscar datos de las alaertas").located(By.cssSelector("[placeholder='Buscar']"));
