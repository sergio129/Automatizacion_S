...
public class ListasPage {
    ...
    public static final Target INPUT_ROLES_LISTS = Target.the("This the input roles lists").located(By.id("addRolesListParametrization"));
    ...
    public static final Target INPUT_MODULES_LISTS = Target.the("This the input modules lists").located(By.id("addModuleListParametrization"));
    ...
    public static final Target INPUT_LISTS = Target.the("This the input lists").located(By.id("addListParametrization"));
    ...
    public static final Target INPUT_OPTIONS_LISTS = Target.the("This the input options lists").located(By.id("addOptionListParametrization"));
