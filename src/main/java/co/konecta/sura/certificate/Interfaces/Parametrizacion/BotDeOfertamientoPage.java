...
public class BotDeOfertamientoPage {
    ...
    public static final Target CAMPO_DEPARTMENTO = Target.the("CAMPO DEPARTAMENTO DE PARAMETRIZACION BOT MONITOREO").located(By.id("selectDepartamentMonitoringBotParametrization"));
    public static final Target BUSCAR_DEPARTMENTO = Target.the("BUSCAR DEPARTAMENTO DE PARAMETRIZACION BOT MONITOREO").located(By.id("inputCreateDepartamentMonitoringBotParametrization"));
    public static final Target CAMPO_MUNICICPIO = Target.the("CAMPO MUNICIPIO DE PARAMETRIZACION BOT MONITOREO").located(By.id("selectMunicipalitiesMonitoringBotParametrization"));
    ...
    public static final Target BUSCAR_SERVICIO_ESPECIL = Target.the("BUSCAR SERVICIO ESPECIAL DE PARAMETRIZACION BOT MONITOREO").located(By.cssSelector("[placeholder='Buscar']"));
