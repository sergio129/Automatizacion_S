...
public class ReprogramacionDeCitasPage {
   ...
   /// public static final Target BOTON_CREAR_MODULO_REPROGRAMACION_CITAS = Target.the("BOTON PARA LA CREACION MODULO DE REPROGRAMACION DE CITAS").located(By.cssSelector("[aria-hidden='true']"));
    ...
    public static final Target BOTON_GUARDAR_REPROGRAMACION_CITAS = Target.the("BOTON PARA GUARDAR DE REPROGRAMACION DE CITAS").located(By.cssSelector("[type='submit']"));
    public static final Target SELECCIONAR_FECHA_REPROGRAMACION_CITAS = Target.the("SELECCIONAMOS FECHA GUARDAR DE REPROGRAMACION DE CITAS").locatedBy("//*[@aria-label='{0}']");
