...
public class SolicitudReclamacionesPage {
    ...
    public static final Target CAMPO_OBSERVACIONES = Target.the("CAMPO OBSERVACIONES").located(By.cssSelector("[placeholder='Observaciones']"));
    public static final Target BOTON_AGREGAR_GESTION = Target.the("BOTON AGREGAR GESTION").located(By.id("#"));
