...
public class AsignacionPage {
    ...
    public static final Target BUTTON_SELECT = Target.the("This the button Select assignment parameterization").located(By.cssSelector("[class='mat-option-ripple mat-ripple']"));
