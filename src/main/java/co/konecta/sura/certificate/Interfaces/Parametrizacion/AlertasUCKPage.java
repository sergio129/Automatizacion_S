...
public class AlertasUCKPage {
    ...
    public static final Target CAMPO_LINEA_PARAMETRIZACION_ALERTAS_UCK = Target.the("CAMPO LINEA DE PARAMETRIZACION ALERTAS UCK").located(By.cssSelector("[placeholder='Linea *']"));
    ...
    public static final Target SELECCIONAR_REGISTRO_PARAMETRIZACION_ALERTAS_UCK = Target.the("SELECCIONAR REGISTROS PARAMETRIZACION ALERTAS UCK").located(By.cssSelector("//mat-option/span[contains(text(),'{0}')]"));
    ...
    public static final Target CAMPO_ESTADO_CIERRE_EXPEDIENTE_PARAMETRIZACION_ALERTAS_UCK = Target.the("CAMPO ESTADO GESTION DE EXPEDIENTE PARAMETRIZACION ALERTAS UCK").located(By.cssSelector("[placeholder='Estado cierre expediente']"));
