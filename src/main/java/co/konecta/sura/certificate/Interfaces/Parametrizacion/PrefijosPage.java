...
public class PrefijosPage {
    ...
    public static final Target SELECIONAMOS_LINEA = Target.the("Damos click en la linea encontrada").locatedBy("/html/body/div[2]/div[4]/div/div/div/mat-option[2]/span");
