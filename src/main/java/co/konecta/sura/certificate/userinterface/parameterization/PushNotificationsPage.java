...
public class PushNotificationsPage {
    ...
    public static final Target INPUT_SERVICE_PUSH_NOTIFICATIONS = Target.the("This the input service push notifications parameterization").located(By.id("mat-select-value-13"));
    ...
    public static final Target INPUT_SERVICE_STATUS_PUSH_NOTIFICATIONS = Target.the("This the input service status push notifications parameterization").located(By.id("mat-select-value-15"));
    ...
    public static final Target INPUT_ROLES_PUSH_NOTIFICATIONS = Target.the("This the input roles push notifications parameterization").located(By.id("mat-select-value-17"));
    ...
    public static final Target INPUT_MOMENT1_PUSH_NOTIFICATIONS = Target.the("This the input moment1 push notifications parameterization").located(By.id("inputTimeMomentOnePushNotification"));
    public static final Target INPUT_MOMENT2_PUSH_NOTIFICATIONS = Target.the("This the input moment1 push notifications parameterization").located(By.id("mat-input-3"));
    ...
    public static final Target INPUT_SERVICE_STATUS_FILTER_PUSH_NOTIFICATIONS = Target.the("This the input service status push filter notifications parameterization").located(By.id("mat-select-value-5"));
    ...
    public static final Target INPUT_ROLES__FILER_PUSH_NOTIFICATIONS = Target.the("This the input roles push notifications parameterization").located(By.id("mat-select-value-7"));
