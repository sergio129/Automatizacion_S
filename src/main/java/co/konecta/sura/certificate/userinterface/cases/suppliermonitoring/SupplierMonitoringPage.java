package co.konecta.sura.certificate.userinterface.cases.suppliermonitoring;
...
public class SupplierMonitoringPage {
    ...
    public static final Target MODULE_EXPANSION_MONITORING = Target.the("This the expansion module monitoring task").located(By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-create-edit-monitorintask/div[3]/app-list-provider-monitoring/mat-expansion-panel/mat-expansion-panel-header"));
