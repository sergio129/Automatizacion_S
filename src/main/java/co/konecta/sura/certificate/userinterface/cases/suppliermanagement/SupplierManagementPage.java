package co.konecta.sura.certificate.userinterface.cases.suppliermanagement;
...
public class SupplierManagementPage {
    ...
    public static final Target BUTTON_CREATE_SUPPLIER = Target.the("This the button create supplier").located(By.id("createProviderManagement"));
