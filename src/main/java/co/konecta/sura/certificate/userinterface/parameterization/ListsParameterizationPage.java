...
public class ListsParameterizationPage {
    ...
    public static final Target INPUT_ROLES_LISTS = Target.the("This the input roles lists").located(By.id(""));
    ...
    public static final Target BUTTON_CREATE_LISTS = Target.the("This the button create lists").located(By.id(""));
    public static final Target BUTTON_CREATE_OPTION_LISTS = Target.the("This the button create option lists").located(By.id(""));
    public static final Target BUTTON_EDIT_LISTS = Target.the("This the button edit lists").located(By.id(""));
    ...
    public static final Target BUTTON_CANCEL_LISTS = Target.the("This the button cancel lists").located(By.id(""));
