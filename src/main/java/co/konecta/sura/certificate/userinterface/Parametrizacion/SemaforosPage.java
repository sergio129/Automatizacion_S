...
public class SemaforosPage {
    ...
    public static final Target INPUT_SERVICE_STATUS_TRAFFIC = Target.the("This the input service status traffic light parameterization").located(By.id("mat-select-value-5"));
    ...
    public static final Target INPUT_LINE_TRAFFIC_LIGHT = Target.the("This the input line traffic light parameterization").located(By.id("mat-select-value-7"));
    ...
    public static final Target INPUT_SERVICE_TRAFFIC_LIGHT = Target.the("This the input service traffic light parameterization").located(By.id("mat-select-value-9"));
    ...
    public static final Target OPTION_YES_DELETE_TRAFFIC_LIGHT = Target.the("This the button yes traffic light parameterization").located(By.id("sweetalertConfirmButton"));
