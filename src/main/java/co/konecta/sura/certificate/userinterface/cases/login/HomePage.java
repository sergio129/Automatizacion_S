package co.konecta.sura.certificate.userinterface.cases.login;
...
public class HomePage extends PageObject {
  ...
  //  public static final Target BUTTON_SONORA_NOTIFICATION = Target.the("This the input final creation date").locatedBy("//input[@id='finalCreationDate']");
    ...
    public static final Target OPTION_MENU_PARAMETERIZATION = Target.the("This the button menu parameterization").located(By.id("moCases"));
    ...
    public static final Target OPTION_LIST_PARAMETERIZATION = Target.the("This the button lists parameterization").located(By.id(""));
    ...
    public static final Target OPTION_STRATEGY_PARAMETERIZATION = Target.the("This the button strategy parameterization").located(By.id(""));
    public static final Target OPTION_ASSIGNMENT_PARAMETERIZATION = Target.the("This the button assignment parameterization").located(By.id(""));
    public static final Target OPTION_ALERT_TIME_PARAMETERIZATION = Target.the("This the button alert time parameterization").located(By.id(""));
