...
public class HideMonitoringTasksPage {
    ...
    public static final Target BUTTON_CREATE_HIDE_TASK = Target.the("This the button create hide monitoring task parameterization").located(By.id("btnAddHide"));
    public static final Target BUTTON_EDIT_HIDE_TASK= Target.the("This the button edit hide monitoring task parameterization").located(By.id("btnEditHide"));
    public static final Target BUTTON_DELETE_HIDE_TASK = Target.the("This the button delete hide monitoring task parameterization").located(By.id("btnDeleteHide"));
    public static final Target OPTION_YES_HIDE_TASK = Target.the("This the button yes hide monitoring task parameterization").located(By.id("sweetalertConfirmButton"));
    public static final Target BUTTON_SAVE_HIDE_TASK = Target.the("This the button save hide monitoring task parameterization").located(By.id("btnSaveHide"));
    public static final Target BUTTON_SEARCH_HIDE_TASK = Target.the("This the button search hide monitoring task parameterization").located(By.id("btnSearchHide"));
