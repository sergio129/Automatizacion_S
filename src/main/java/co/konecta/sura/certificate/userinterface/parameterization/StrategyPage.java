...
public class StrategyPage {
    ...
    public static final Target INPUT_CONTINGENCY = Target.the("This the input contingency").located(By.id("mat-select-value-11"));
    ...
    public static final Target INPUT_COORDINATION_STRATEGY = Target.the("This the input coordination strategy").located(By.id(""));
    public static final Target INPUT_TIME_ASSIGNMENT = Target.the("This the input time for assignment").located(By.id(""));
    public static final Target INPUT_FIRST_EXPIRATION_TIME = Target.the("This the input first expiration time").located(By.id(""));
    public static final Target INPUT_SECOND_EXPIRATION_TIME = Target.the("This the input second expiration time").located(By.id(""));
    public static final Target INPUT_MONITORING_STRATEGY = Target.the("This the input monitoring strategy").located(By.id(""));
    public static final Target INPUT_PREVENTIVE_MONITORING_TIME_= Target.the("This the input preventive monitoring time").located(By.id(""));
    public static final Target INPUT_TIME_MONITORING_SITE = Target.the("This the input time monitoring on site").located(By.id(""));
    public static final Target INPUT_TIME_MONITORING_COMPLETION = Target.the("This the input time monitoring completion").located(By.id(""));
   ...
   public static final Target INPUT_SEARCH_STRATEGY_NAME = Target.the("This the input search strategy name").located(By.id("nombreStrategy"));
   //public static final Target INPUT_SEARCH_STRATEGY_NAME = Target.the("This the input search strategy name").locatedBy("/html/body/app-root/app-full-layout/div/mat-sidenav-container/mat-sidenav-content/div/app-strategy/div[1]/div/mat-card/mat-card-content/div[1]/mat-form-field/div/div[1]/div/input");
    public static final Target BUTTON_SEARCH_STRATEGY = Target.the("This the button search strategy").located(By.id(""));
   // public static final Target BUTTON_EDIT_CONTINGENCY_STRATEGY = Target.the("This the button edit contingency strategy").locatedBy("/html/body/app-root/app-full-layout/div/mat-sidenav-container/mat-sidenav-content/div/app-strategy/div[2]/div/mat-card/mat-card-content/div/mat-table/mat-row[1]/mat-cell[5]/button[2]");
