...
public class StrategyPage {
    ...
    public static final Target INPUT_CONTINGENCY = Target.the("This the input contingency").located(By.id(""));
    public static final Target INPUT_CONTINGENCY_DESCRIPTION = Target.the("This the input contingency description").located(By.id(""));
    ...
    public static final Target INPUT_SEARCH_STRATEGY_NAME = Target.the("This the input search strategy name").located(By.id(""));
    public static final Target BUTTON_SEARCH_STRATEGY = Target.the("This the button search strategy").located(By.id(""));
    public static final Target BUTTON_EDIT_CONTINGENCY_STRATEGY = Target.the("This the button edit contingency strategy").located(By.id(""));
    ...
    public static final Target BUTTON_SAVE_STRATEGY = Target.the("This the button save strategy").located(By.id(""));
