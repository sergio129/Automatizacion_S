...
public class HideMonitoringTasksTask implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                Enter.theValue(lineTask).into(INPUT_SEARCH_LINE_HIDE_TASK),
                Click.on(INPUT_SERVICE_HIDE_TASK),
                Enter.theValue(serviceTask).into(INPUT_SEARCH_SERVICE_HIDE_TASK),
                Click.on(INPUT_TYPE_HIDE_TASK),
                Enter.theValue(taskType).into(INPUT_SEARCH_TYPE_HIDE_TASK),
