...
public class CaseClosureTask implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                Enter.theValue(lineClosure).into(INPUT_SEARCH_LINE_CLOSURE).thenHit(Keys.ENTER),
                Click.on(INPUT_SERVICE_CLOSURE),
                Enter.theValue(serviceClosure).into(INPUT_SEARCH_SERVICE_CLOSURE).thenHit(Keys.ENTER),
