Feature: Call reasons parameterization
  ...
  Scenario Outline: Successful call reasons Service Request Not Catastrophic Event
    ...
    Examples:
      | user         | password       | name                                        | line  | modalmessage                                                                                  |
      | Sergio.anaya | Colombia_2025* | Pruebas Automatizacion Evento Catastrofico2 | Hogar | Registro guardado correctamente                                                               |
      | Sergio.anaya | Colombia_2025* | Pruebas Automatizacion Evento Catastrofico2 | Hogar | No se puede guardar, Ya se encuentra parametrizado un servicio de llamada con el mismo nombre |
  ...
  Scenario Outline: Successful call reasons Service Request Not Catastrophic Event
    ...
    Examples:
      ...
      | Sergio.anaya | Colombia_2025* | Pruebas Automatizacion Evento Catastrofico2 | Hogar | 55     | Registro guardado correctamente                                                               |
      | Sergio.anaya | Colombia_2025* | Pruebas Automatizacion Evento Catastrofico2 | Hogar | 55     | No se puede guardar, Ya se encuentra parametrizado un servicio de llamada con el mismo nombre |
