Feature: Monitoring
  ...
  Scenario Outline: Successful task monitoring creation
    ...
    Examples:
      ...
      | Sergio.anaya | Colombia_2026* | B202201064435401 | Prueba | Monitoreo finalizacion del servicio | 2021-05-31 | 09:19am     | Yesenia        | Registro guardado correctamente |
  ...
  Scenario Outline: Successful task monitoring edition
    ...
    Examples:
      | usuario      | contrasena     | numberCase       | state   | type                                | date       | expiredhour | userMonitoring    | modalmessage                    |
      | Sergio.anaya | Colombia_2026* | B202201064435401 | Cerrada | Monitoreo finalizacion del servicio | 2021-05-31 | 05:19am     | Sergio Luis Anaya | Registro guardado correctamente |
